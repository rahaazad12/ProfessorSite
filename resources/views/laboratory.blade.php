...
@section('header')
    <div style="background-color:#1b4b72">
        ...
        <h3 style="text-align: center;margin-bottom:0;margin-top: 2px;color: whitesmoke"><b>آزمایشگاه نانو مواد مگنتو
                اپتیکی</b></h3></div>
    <div
            style="background-image:url('{{asset("image/laboratory.jpg")}}') ; background-repeat: no-repeat;width:100%;height:45%">
    </div>
    ...
    <div style="text-align: right;margin-bottom:10px">
        <ul>
            ...
            <li><a class="active" href="{{ url('/laboratory') }}">آزمایشگاه</a></li>
