        ...
        <div class="col-sm-10 col-sm-offset-1 col-lg-10 col-lg-offset-1">
            <div class="panel panel-default panel-border">
                ...
                <div class="panel-body">
                    <form method="POST" class="form-horizontal" role="form" action="{{ url('admin/research_head/'.$research_head->id) }}"
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="name" type="text" class="form-control @error('name') is-invalid @enderror" name="name"
                                       value="{{ $research_head->name }}" required autocomplete="name" autofocus>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="exp" type="text" class="form-control" name="exp"
                                       value="{{ $research_head->exp }}" required autocomplete="exp" autofocus>
                            </div>
                        </div>
                        <div class="form-group">
