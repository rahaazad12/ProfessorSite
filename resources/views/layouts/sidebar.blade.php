<nav style="z-index:3;width:200px;"><br>
    <div >
        <a href="{{asset("image/ProfessorImage.jpg")}}">
        <img src="{{asset("image/ProfessorImage.jpg")}}" style="width:80%;margin-right:30px"></a><br><br>
    </div>
    <div >
        ...
        <div>
            ...
            <p style="text-align: right;margin-right:10px">
                ...
                <br>
                دانشگاه الزهرا، دانشکده فیزیک و شیمی
